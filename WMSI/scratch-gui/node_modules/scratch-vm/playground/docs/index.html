...
<div id="main">
    ...
    <section class="readme">
        <article><h2>scratch-vm</h2><h4>Scratch VM is a library for representing, running, and maintaining the state of computer programs written using <a href="https://github.com/LLK/scratch-blocks">Scratch Blocks</a>.</h4><p><a href="https://travis-ci.org/LLK/scratch-vm"><img src="https://travis-ci.org/LLK/scratch-vm.svg?branch=develop" alt="Build Status"></a>
...
<h2>Installation</h2><p>This requires you to have Git and Node.js installed.</p>
<p>To install as a dependency for your own application:</p>
<pre class="prettyprint source lang-bash"><code>npm install scratch-vm</code></pre><p>To set up a development environment to edit scratch-vm yourself:</p>
<pre class="prettyprint source lang-bash"><code>git clone https://github.com/LLK/scratch-vm.git
cd scratch-vm
npm install</code></pre><h2>Development Server</h2><p>This requires Node.js to be installed.</p>
...
<h2>Running the Development Server</h2><p>Open a Command Prompt or Terminal in the repository and run:</p>
<pre class="prettyprint source lang-bash"><code>npm start</code></pre><h2>Playground</h2><p>To view the Playground, make sure the dev server's running and go to <a href="http://localhost:8073/playground/">http://localhost:8073/playground/</a> - you will be directed to the playground, which demonstrates various tools and internal state.</p>
<p><img src="https://i.imgur.com/nOCNqEc.gif" alt="VM Playground Screenshot"></p>
<h2>Standalone Build</h2><pre class="prettyprint source lang-bash"><code>npm run build</code></pre><pre class="prettyprint source lang-html"><code>&lt;script src=&quot;/path/to/dist/web/scratch-vm.js&quot;>&lt;/script>
&lt;script>
    var vm = new window.VirtualMachine();
    // do things
&lt;/script></code></pre><h2>How to include in a Node.js App</h2><p>For an extended setup example, check out the /src/playground directory, which includes a fully running VM instance.</p>
...
// Run threads
vm.start();</code></pre><h2>Abstract Syntax Tree</h2><h4>Overview</h4><p>The Virtual Machine constructs and maintains the state of an <a href="https://en.wikipedia.org/wiki/Abstract_syntax_tree">Abstract Syntax Tree</a> (AST) by listening to events emitted by the <a href="https://github.com/LLK/scratch-blocks">scratch-blocks</a> workspace via the <code>blockListener</code>. Each target (code-running object, for example, a sprite) keeps an AST for its blocks. At any time, the current state of an AST can be viewed by inspecting the <code>vm.runtime.targets[...].blocks</code> object.</p>
<h4>Anatomy of a Block</h4><p>The VM's block representation contains all the important information for execution and storage. Here's an example representing the &quot;when key pressed&quot; script on a workspace:</p>
...
}</code></pre><h2>Testing</h2><pre class="prettyprint source lang-bash"><code>npm test</code></pre><pre class="prettyprint source lang-bash"><code>npm run coverage</code></pre><h2>Publishing to GitHub Pages</h2><pre class="prettyprint source lang-bash"><code>npm run deploy</code></pre><p>This will push the currently built playground to the gh-pages branch of the
currently tracked remote.  If you would like to change where to push to, add
a repo url argument:</p>
<pre class="prettyprint source lang-bash"><code>npm run deploy -- -r &lt;your repo url></code></pre><h2>Donate</h2><p>We provide <a href="https://scratch.mit.edu">Scratch</a> free of charge, and want to keep it that way! Please consider making a <a href="https://secure.donationpay.org/scratchfoundation/">donation</a> to support our continued engineering, design, community, and resource development efforts. Donations of any size are appreciated. Thank you!</p></article>
    </section>
...
<dl class="details">
                ...
                <div class="description"><p>A utility for accurately measuring time.</p>
<h2>To use:</h2><p>var timer = new Timer();
timer.start();
... pass some time ...</p>
<h2>var timeDifference = timer.timeElapsed();</h2><p>Or, you can use the <code>time</code> and <code>relativeTime</code>
