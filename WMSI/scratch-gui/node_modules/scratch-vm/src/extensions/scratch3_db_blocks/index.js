...
class Scratch3DatabaseBlocks {
     ...
     * @param {array} dataSet - array of all elements in the data set
     ...
     */
    getDataElement (args) {
        // var data_set = this._getLocalVariable(data_set);
        // console.log('data set: ' + data_set);
        var data_set = JSON.parse(this._getLocalVariable('data_set'));
