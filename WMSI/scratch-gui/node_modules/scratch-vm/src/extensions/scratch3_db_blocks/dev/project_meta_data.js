...
class Scratch3DatabaseBlocks {
    ...
    _addProject(project) {
        var all_projects = this._getLocalVariable('projects');
    ...
    _getProjectIDs() {
        ...
        if(all_projects && all_projects != "undefined") {
            ...
            console.log('projids: ' + String(project_ids));
            ...
            blocks: [
                ...
                // as the defining user interface?
                {
                    ...
                    text: formatMessage({
                        ...
                        default: 'Get field [FIELD] for project [PROJECT_ID]',
    ...
    pullDataSet(args) { 
        ...
        var query_string = 'localhost:5000/scratchx' + '?project_id=' + String(args.PROJECT_ID) + '&data_type=' + String(args.DATA_TYPE);
        var self = this;
     ...
     */
     getProject(args) {
        ...
        var query_string = 'localhost:5000/scratchx' + '?project_id=' + String(args.PROJECT_ID) + '&pmd=true';
        var self = this;
     ...
     * @param {number} PROEJCT_ID - id of the project
     * @returns {string} - attribute for the meta data field 
     */ 
    getProjectMetaData(args) {
        console.log('get metadata field ' + String(args.FIELD) + ' from project ' + args.PROJECT_ID);
        var all_projects = this._getLocalVariable('all_projects');
        if(all_projects && all_projects != "undefined") {
            all_projects = JSON.parse(all_projects);
            ...
            // for(var i=0; i<all_projects.length; i++) {
            //     if(all_projects[i].id == args.PROJECT_ID) {
            //         return all_projects[i][args.FIELD];
            //     }
