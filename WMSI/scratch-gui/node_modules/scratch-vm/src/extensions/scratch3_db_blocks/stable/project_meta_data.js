...
class Scratch3DatabaseBlocks {
    ...
    getDataSet(args) {
        ...
        if(all_projects && all_projects != "undefined") {
            ...
            console.log('found project ' + args.PROJECT_ID + ' with name ' + this_project.name);
            if(this_project['data_sets'].hasOwnProperty(args.DATA_TYPE)) {
                console.log('found data set: ' + ['data_sets'][args.DATA_TYPE]);
    ...
    getProjectMetaData(args) {
        ...
        if(all_projects && all_projects != "undefined") {
            all_projects = JSON.parse(all_projects);
            var this_project = all_projects[all_projects.findIndex(e => e.id === args.PROJECT_ID)];
