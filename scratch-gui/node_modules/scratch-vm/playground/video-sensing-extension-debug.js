    ...
    _createClass(VideoMotionView, [{
        ...
        value: function draw() {
            ...
            if (this.output === OUTPUT.XYT) {
                this._eachAddress(1, 1, WIDTH - 1, HEIGHT - 1, function (address) {
                    var _grads3 = _this3._grads(address),
                        gradX = _grads3.gradX,
                        gradY = _grads3.gradY,
                        gradT = _grads3.gradT;
            ...
            if (this.output === OUTPUT.XYT_CELL) {
                ...
                this._eachCell(WINSIZE + 1, WINSIZE + 1, wmax, hmax, winStep, winStep, function (eachAddress) {
                    ...
                    eachAddress(function (address) {
                        var _grads4 = _this3._grads(address),
                            gradX = _grads4.gradX,
                            gradY = _grads4.gradY,
                            gradT = _grads4.gradT;
            ...
            if (this.output === OUTPUT.XY) {
                this._eachAddress(1, 1, WIDTH - 1, HEIGHT - 1, function (address) {
                    var _grads5 = _this3._grads(address),
                        gradX = _grads5.gradX,
                        gradY = _grads5.gradY;
            ...
            if (this.output === OUTPUT.XY_CELL) {
                ...
                this._eachCell(WINSIZE + 1, WINSIZE + 1, _wmax, _hmax, _winStep, _winStep, function (eachAddress) {
                    ...
                    eachAddress(function (address) {
                        var _grads6 = _this3._grads(address),
                            gradX = _grads6.gradX,
                            gradY = _grads6.gradY;
                ...
                this._eachAddress(1, 1, WIDTH - 1, HEIGHT - 1, function (address) {
                    var _grads7 = _this3._grads(address),
                        gradT = _grads7.gradT;
            ...
            if (this.output === OUTPUT.T_CELL) {
                ...
                this._eachCell(WINSIZE + 1, WINSIZE + 1, _wmax2, _hmax2, _winStep2, _winStep2, function (eachAddress) {
                    ...
                    eachAddress(function (address) {
                        var _grads8 = _this3._grads(address),
                            gradT = _grads8.gradT;
                ...
                this._eachAddress(1, 1, WIDTH - 1, HEIGHT - 1, function (address) {
                    var _grads9 = _this3._grads(address),
                        gradX = _grads9.gradX,
                        gradY = _grads9.gradY,
                        gradT = _grads9.gradT;
            ...
            if (this.output === OUTPUT.C_CELL) {
                ...
                this._eachCell(WINSIZE + 1, WINSIZE + 1, _wmax3, _hmax3, _winStep3, _winStep3, function (eachAddress) {
                    var _components2 = _this3._components(eachAddress),
                        C2 = _components2.C2,
                        C1 = _components2.C1;
                ...
                this._eachAddress(1, 1, WIDTH - 1, HEIGHT - 1, function (address) {
                    var _grads10 = _this3._grads(address),
            ...
            if (this.output === OUTPUT.AB_CELL) {
                ...
                this._eachCell(WINSIZE + 1, WINSIZE + 1, _wmax4, _hmax4, _winStep4, _winStep4, function (eachAddress) {
                    var _components3 = _this3._components(eachAddress),
                        A2 = _components3.A2,
                        A1B2 = _components3.A1B2,
                        B1 = _components3.B1;
                ...
                this._eachAddress(1, 1, WIDTH - 1, HEIGHT - 1, function (address) {
                    var _components4 = _this3._components(function (fn) {
                        return fn(address);
                    }),
                        A2 = _components4.A2,
                        A1B2 = _components4.A1B2,
                        B1 = _components4.B1,
                        C2 = _components4.C2,
                        C1 = _components4.C1;
                ...
                this._eachCell(WINSIZE + 1, WINSIZE + 1, _wmax5, _hmax5, _winStep6, _winStep6, function (eachAddress) {
                    var _components5 = _this3._components(eachAddress),
                        A2 = _components5.A2,
                        A1B2 = _components5.A1B2,
                        B1 = _components5.B1,
                        C2 = _components5.C2,
                        C1 = _components5.C1;
