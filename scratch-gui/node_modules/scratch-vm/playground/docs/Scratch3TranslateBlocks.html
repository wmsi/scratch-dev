...
<div class="description">
    <p>A randomly selected language code, for use as the default value in the language menu.</p>
</div>
...
<div class="description">
    <p>List of supported language name and language code pairs, for use in the block menu.</p>
</div>
