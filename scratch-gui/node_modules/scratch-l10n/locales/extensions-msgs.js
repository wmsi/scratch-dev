...
export default {
  "ab": {
    ...
    "microbit.defaultTextToDisplay": "Абзиара шәымаз!",
    "microbit.displaySymbol": "аекран [MATRIX]",
    "microbit.displayText": "аекран [TEXT]",
    ...
    "microbit.isTilted": "иргьежьтәума [DIRECTION]?",
    ...
    "microbit.tiltDirectionMenu.front": "ахҟьа",
    ...
    "microbit.whenPinConnected": "[PIN] аҿакра иазку атест",
    "microbit.whenTilted": "[DIRECTION] аргьежьраан",
    ...
    "music.setInstrument": "иқәыргылатәуп амаруга [INSTRUMENT] аҟны",
    ...
    "speech.extensionName": "Google Абжьы",
    "speech.listenAndWait": "Шазыӡырҩы нас шәазыԥшы",
    ...
    "text2speech.max": "max",
    "text2speech.monster": "амонстр",
    "text2speech.puppy": "аласба",
    "text2speech.quinn": "куин",
    "text2speech.setVoiceBlock": "иқәыргылатәуп абжьы [VOICE] аҟны",
    "text2speech.speakAndWaitBlock": "иҳәатәуп [WORDS]",
    "text2speech.squeak": "аҷыжьбжьы",
    "translate.categoryName": "Google Аиҭагаҩ",
    ...
    "videoSensing.setVideoTransparency": "Иқәыргылатәуп авидео аҵәцара [TRANSPARENCY] аҟны",
    ...
    "wedo2.isTilted": "иргьежьтәума [TILT_DIRECTION_ANY]?",
    "wedo2.motorOff": "[MOTOR_ID] аҿыхра",
    "wedo2.motorOn": "[MOTOR_ID] аҿакра",
    "wedo2.motorOnFor": "иаҿактәуп  [MOTOR_ID] [DURATION] сек",
    "wedo2.playNoteFor": "анота [NOTE] ихәмартәуп [DURATION] сек",
    "wedo2.setLightHue": "иқәыргылатәуп аԥштәы арлашара [HUE]",
    ...
    "wedo2.whenTilted": "[TILT_DIRECTION_ANY] аргьежьраан"
  },
  "az": {
    ...
    "microbit.displayText": "[TEXT] ekranı",
    ...
    "speech.extensionName": "Google danışıq",
    ...
    "text2speech.monster": "canavar",
    "text2speech.puppy": "küçük",
    ...
    "translate.categoryName": "Google Tərcümə",
  ...
  "id": {
    ...
    "microbit.displayText": "display [TEXT]",
    ...
    "microbit.whenPinConnected": "when pin [PIN] connected test",
    ...
    "speech.extensionName": "Google Speech",
  ...
  "ca": {
    ...
    "microbit.displayText": "mostra [TEXT]",
    ...
    "translate.categoryName": "Traductor de Google",
  ...
  "cs": {
    ...
    "ev3.whenButtonPressed": "when button [PORT] pressed",
    "ev3.whenDistanceLessThan": "when distance < [DISTANCE]",
    "microbit.buttonsMenu.any": "libovolná",
    "microbit.clearDisplay": "clear display",
    ...
    "microbit.tiltAngle": "tilt angle [DIRECTION]",
    "microbit.tiltDirectionMenu.any": "libovolná",
    "microbit.tiltDirectionMenu.back": "zpět",
    "microbit.tiltDirectionMenu.front": "popředí",
    ...
    "speech.extensionName": "Mluvené slovo z Google",
    ...
    "text2speech.monster": "netvor",
    "text2speech.puppy": "štěně",
    ...
    "translate.categoryName": "Překlad Google",
  ...
  "cy": {
    ...
    "microbit.displayText": "dangos [TEXT]",
    ...
    "microbit.whenPinConnected": "pan mae pin [PIN] yn profi'r cysylltiad",
    ...
    "text2speech.monster": "anghenfil",
    "text2speech.puppy": "ci bach",
    ...
    "wedo2.whenTilted": "pan wedi ei ogwyddo [TILT_DIRECTION_ANY]"
  },
  "da": {
    "ev3.beepNote": "spil node [NOTE] i [TIME] sekunder",
    "ev3.buttonPressed": "knap [PORT] trykket?",
    "ev3.getBrightness": "lysstyrke",
    "ev3.getDistance": "afstand",
    "ev3.getMotorPosition": "motor [PORT] position",
    "ev3.motorSetPower": "motor [PORT] indstil kraft til [POWER] %",
    "ev3.motorTurnClockwise": "motor [PORT] drej med uret i [TIME] sekunder",
    "ev3.motorTurnCounterClockwise": "motor [PORT] drej mod uret [TIME] sekunder",
    "ev3.whenBrightnessLessThan": "når lysstyrke < [DISTANCE]",
    "ev3.whenButtonPressed": "når knap [PORT] er trykket",
    ...
    "microbit.whenButtonPressed": "når [BTN]knappen er trykket",
    "microbit.whenGesture": "når [GESTURE]",
    "microbit.whenPinConnected": "når pin [PIN] er forbundet",
    "microbit.whenTilted": "når vippet [DIRECTION]",
    "music.categoryName": "Musik",
    ...
    "speech.extensionName": "Google Tale",
    ...
    "text2speech.max": "Max",
    "text2speech.monster": "monster",
    "text2speech.puppy": "hundehvalp",
    "text2speech.quinn": "Quinn",
    "text2speech.setVoiceBlock": "indstil stemme til [VOICE]",
    "text2speech.speakAndWaitBlock": "sig [WORDS]",
    "text2speech.squeak": "knirke",
    "translate.categoryName": "Oversæt med Google",
    ...
    "wedo2.whenTilted": "når vippet [TILT_DIRECTION_ANY]"
  },
  "de": {
    ...
    "speech.extensionName": "Google-Spracherkennung",
    ...
    "translate.categoryName": "Google-Übersetzung",
  ...
  "et": {
    ...
    "text2speech.squeak": "squeak",
    "translate.categoryName": "Google'i Tõlgi",
  ...
  "el": {
    ...
    "text2speech.squeak": "squeak",
    "translate.categoryName": "Μετάφραση Google",
  ...
  "en": {
    ...
    "pen.categoryName": "Pen",
    "speak.defaultTextToSpeak": "hello",
    "videoSensing.sprite": "sprite",
    ...
    "speak.speakAndWaitBlock": "speak [WORDS]",
    ...
    "videoSensing.categoryName": "Video Motion",
  ...
  "es": {
    ...
    "microbit.displayText": "mostrar [TEXT]",
    ...
    "microbit.whenPinConnected": "al conectar pin [PIN] a toma a tierra",
    ...
    "text2speech.max": "max",
    "text2speech.monster": "monstruo",
    "text2speech.puppy": "cachorro",
    "text2speech.quinn": "quinn",
  ...
  "es-419": {
    "ev3.beepNote": "suena nota [NOTE] por [TIME] segundos",
    "ev3.buttonPressed": "¿está el botón [PORT] presionado?",
    "ev3.getBrightness": "brillo",
    "ev3.getDistance": "distancia",
    "ev3.getMotorPosition": "posición motor [PORT] ",
    "ev3.motorSetPower": "establecer fuerza [POWER] % en motor [PORT]",
    "ev3.motorTurnClockwise": "mover motor [PORT]en esta forma por [TIME]segundos",
    "ev3.motorTurnCounterClockwise": "mover motor [PORT]en aquella forma por [TIME]segundos",
    ...
    "microbit.clearDisplay": "limpiar pantalla",
    "microbit.defaultTextToDisplay": "¡Hola!",
    "microbit.displaySymbol": "muestra [MATRIX]",
    "microbit.displayText": "muestra [TEXT]",
    "microbit.gesturesMenu.jumped": "saltó",
    "microbit.gesturesMenu.moved": "se movió",
    "microbit.gesturesMenu.shaken": "se sacudió",
    "microbit.isButtonPressed": "¿botón [BTN] presionado?",
    "microbit.isTilted": "¿giro [DIRECTION]?",
    "microbit.pinStateMenu.off": "apagado",
    "microbit.pinStateMenu.on": "encendido",
    "microbit.tiltAngle": "ángulo de giro [DIRECTION]",
    "microbit.tiltDirectionMenu.any": "Cualquiera",
    "microbit.tiltDirectionMenu.back": "regresar",
    "microbit.tiltDirectionMenu.front": "del frente",
    "microbit.tiltDirectionMenu.left": "izquierda",
    "microbit.tiltDirectionMenu.right": "derecha",
    "microbit.whenButtonPressed": "cuanto botón [BTN] está presionado",
    "microbit.whenGesture": "cuando [GESTURE]",
    "microbit.whenPinConnected": "cuando pin [PIN]está conectado",
    "microbit.whenTilted": "cuando gira [DIRECTION]",
    "music.categoryName": "Música",
    ...
    "pen.stamp": "sello",
    "speech.defaultWhenIHearValue": "vamos",
    "speech.extensionName": "Google Voz",
    "speech.listenAndWait": "escucha y espera",
    "speech.speechReporter": "voz",
    "speech.whenIHear": "cuando escucho [PHRASE]",
    "text2speech.defaultTextToSpeak": "hola",
    "text2speech.kitten": "gatito",
    "text2speech.max": "max",
    "text2speech.monster": "monstruo",
    "text2speech.puppy": "cachorro",
    "text2speech.quinn": "quinn",
    "text2speech.setVoiceBlock": "establecer voz a [VOICE]",
    "text2speech.speakAndWaitBlock": "decir [WORDS]",
    "text2speech.squeak": "chirrido",
    "translate.categoryName": "Traductor de Google",
    "translate.defaultTextToTranslate": "hola",
    "translate.translateBlock": "traduce [WORDS] a [LANGUAGE]",
    ...
    "wedo2.getDistance": "distancia",
    "wedo2.getTiltAngle": "ángulo de giro [TILT_DIRECTION]",
    "wedo2.isTilted": "¿giro [TILT_DIRECTION_ANY]?",
    "wedo2.motorOff": "apagar [MOTOR_ID]",
    "wedo2.motorOn": "encender [MOTOR_ID]",
    ...
    "wedo2.whenTilted": "cuando gira [TILT_DIRECTION_ANY]"
  },
  "fr": {
    ...
    "microbit.displayText": "afficher [TEXT]",
    ...
    "speech.extensionName": "Google Sppech",
    ...
    "translate.categoryName": "Google Traduction",
  ...
  "ga": {
    ...
    "microbit.displayText": "taispeáin [TEXT]",
    ...
    "microbit.whenPinConnected": "agus pionna [PIN] ceangailte",
    ...
    "text2speech.monster": "arracht",
    "text2speech.puppy": "coileáinín",
    ...
    "translate.categoryName": "Praistriúchán Google",
  ...
  "gd": {
    ...
    "microbit.displayText": "seall [TEXT]",
    ...
    "microbit.whenPinConnected": "le deuchainn air ceangal prìne [PIN]",
    ...
    "text2speech.monster": "biast",
    "text2speech.puppy": "cuilean",
  ...
  "gl": {
    ...
    "ev3.buttonPressed": "botón [PORT] premido?",
    "ev3.getBrightness": "luminosidade",
    "ev3.getDistance": "distancia",
    "ev3.getMotorPosition": "posición do motor [PORT]",
    "ev3.motorSetPower": "no motor [PORT] poñer a potencia ao [POWER] %",
    "ev3.motorTurnClockwise": "o motor [PORT] virar para aquí durante [TIME] segundos",
    "ev3.motorTurnCounterClockwise": "o motor [PORT] virar para alá durante [TIME] segundos",
    ...
    "microbit.isButtonPressed": "botón [BTN] premido?",
    ...
    "microbit.tiltDirectionMenu.back": "atrás",
    "microbit.tiltDirectionMenu.front": "diante",
    "microbit.tiltDirectionMenu.left": "esquerda",
    "microbit.tiltDirectionMenu.right": "dereita",
    "microbit.whenButtonPressed": "ao premer o botón [BTN]",
    "microbit.whenGesture": "ao [GESTURE]",
    "microbit.whenPinConnected": "cando o pin [PIN] proba conectado",
    "microbit.whenTilted": "ao estar inclinado [DIRECTION]",
    "music.categoryName": "Música",
    "music.changeTempo": "cambiar tempo por [TEMPO]",
    "music.drumBass": "(2) Bombo",
    "music.drumBongo": "(13) Bongó",
    ...
    "music.setInstrument": "fixar o instrumento en [INSTRUMENT]",
    "music.setTempo": "fixar o tempo en [TEMPO]",
    "pen.categoryName": "Lapis",
    "pen.changeColorParam": "cambiar lapis [COLOR_PARAM] en [VALUE]",
    "pen.changeHue": "cambiar cor do lapis en [HUE]",
    "pen.changeShade": "cambiar intensidade do lapis en [SHADE]",
    "pen.changeSize": "cambiar tamaño do lapis en [SIZE]",
    "pen.clear": "borrar todos",
    "pen.colorMenu.brightness": "luminosidade",
    "pen.colorMenu.color": "cor",
    "pen.colorMenu.saturation": "saturación",
    "pen.colorMenu.transparency": "transparencia",
    "pen.penDown": "baixar lapis",
    "pen.penUp": "subir lapis",
    "pen.setColor": "fixar cor do lapis a [COLOR]",
    "pen.setColorParam": "fixar lapis [COLOR_PARAM] a [VALUE]",
    "pen.setHue": "fixar cor do lapis a [HUE]",
    "pen.setShade": "fixar intensidade do lapis a [SHADE]",
    "pen.setSize": "fixar tamaño do lapis a [SIZE]",
    "pen.stamp": "selar",
    ...
    "text2speech.monster": "monstro",
    "text2speech.puppy": "cadelo",
    ...
    "videoSensing.setVideoTransparency": "fixar transparencia de vídeo en [TRANSPARENCY]",
    "videoSensing.sprite": "figura",
    "videoSensing.stage": "escenario",
    "videoSensing.videoOn": "vídeo [ATTRIBUTE] ao [SUBJECT]",
    ...
    "wedo2.setLightHue": "fixar a cor da luz a [HUE]",
    "wedo2.setMotorDirection": "fixara a dirección de [MOTOR_ID] a [MOTOR_DIRECTION]",
    "wedo2.startMotorPower": "fixar a potencia de [MOTOR_ID] a [POWER]",
    "wedo2.whenDistance": "cando a distancia [OP] [REFERENCE]",
    "wedo2.whenTilted": "cando estea inclinado á [TILT_DIRECTION_ANY]"
  },
  "ko": {
    "ev3.beepNote": "[TIME] 초 동안 [NOTE] 경고음 울리기",
    "ev3.buttonPressed": " [PORT] 버튼이 눌렸는가?",
    "ev3.getBrightness": "명도",
    "ev3.getDistance": "거리",
    "ev3.getMotorPosition": "모터 [PORT] 위치",
    "ev3.motorSetPower": "[PORT] 모터 강도를 [POWER] %로 정하기",
    "ev3.motorTurnClockwise": "[PORT] 방향으로 모터를 [TIME]초 동안 이동하기",
    "ev3.motorTurnCounterClockwise": "[PORT]방향으로 모터를 [TIME]초 동안 이동하기",
    "ev3.whenBrightnessLessThan": "만약 밝기 <  [DISTANCE] 라면",
    "ev3.whenButtonPressed": "만약 [PORT] 버튼이 눌러졌을 때",
    "ev3.whenDistanceLessThan": "만약 거리 < [DISTANCE]라면",
    "microbit.buttonsMenu.any": "아무",
    "microbit.clearDisplay": "화면 정리하기",
    "microbit.defaultTextToDisplay": "안녕!",
    "microbit.displaySymbol": "[MATRIX] 보여주기",
    "microbit.displayText": "[TEXT] 보여주기",
    "microbit.gesturesMenu.jumped": "뛰었다",
    "microbit.gesturesMenu.moved": "이동하면",
    "microbit.gesturesMenu.shaken": "흔들어지면",
    "microbit.isButtonPressed": "[BTN] 버튼이 눌려졌는가?",
    "microbit.isTilted": "[DIRECTION] 방향으로 돌아갔는가?",
    "microbit.pinStateMenu.off": "끄기",
    "microbit.pinStateMenu.on": "켜기",
    "microbit.tiltAngle": "[DIRECTION] 방향으로 이동하기",
    "microbit.tiltDirectionMenu.any": "아무",
    "microbit.tiltDirectionMenu.back": "맨 뒤쪽",
    "microbit.tiltDirectionMenu.front": "맨 앞쪽",
    "microbit.tiltDirectionMenu.left": "왼쪽",
    "microbit.tiltDirectionMenu.right": "오른쪽",
    "microbit.whenButtonPressed": "만약 [BTN] 버튼이 눌러졌을 때",
    "microbit.whenGesture": "만약 [GESTURE]와 동작이 일치할 때",
    "microbit.whenPinConnected": "핀 [PIN]이 시험 연결 되었을 때",
    "microbit.whenTilted": "[DIRECTION] 방향으로 이동했을 때",
    ...
    "wedo2.getTiltAngle": "[TILT_DIRECTION] 방향으로 이동하기",
    "wedo2.isTilted": "[TILT_DIRECTION_ANY] 방향으로 돌아갔는가?",
    "wedo2.motorOff": "[MOTOR_ID] 끄기",
    "wedo2.motorOn": "[MOTOR_ID] 켜기",
    "wedo2.motorOnFor": "[DURATION] 초 간 [MOTOR_ID] 켜기",
    "wedo2.playNoteFor": "[NOTE] 번 음을 [DURATION]초 간 연주하기",
    "wedo2.setLightHue": "LED 색을  [HUE]로 정하기",
    "wedo2.setMotorDirection": "[MOTOR_ID]의 방향을 [MOTOR_DIRECTION]으로 정하기",
    "wedo2.startMotorPower": "[MOTOR_ID] 모터 강도를 [POWER]로 정하기",
    "wedo2.whenDistance": "만약 거리 [OP] [REFERENCE]라면",
    "wedo2.whenTilted": "만약 [TILT_DIRECTION_ANY] 방향으로 돌아가면"
  },
  "he": {
    ...
    "pen.stamp": "חתום",
    "speech.defaultWhenIHearValue": "יאללה",
    "speech.extensionName": "דיבור \"גוגל\"",
    ...
    "text2speech.max": "שמחה",
    "text2speech.monster": "מפלצת",
    "text2speech.puppy": "כלבלב",
    "text2speech.quinn": "שרון",
    "text2speech.setVoiceBlock": "קבע קול ל־[VOICE]",
    "text2speech.speakAndWaitBlock": "אמור [WORDS]",
    "text2speech.squeak": "חריקה",
    "translate.categoryName": "תרגום \"גוגל\"",
  ...
  "it": {
    ...
    "microbit.displayText": "mostra [TEXT] su display ",
    ...
    "microbit.whenPinConnected": "quando pin [PIN] connesso",
    ...
    "speech.extensionName": "Google Riconoscimento Vocale",
    ...
    "text2speech.kitten": "gattino",
    "text2speech.max": "max",
    "text2speech.monster": "mostro",
    "text2speech.puppy": "cagnolino",
    "text2speech.quinn": "alex",
    "text2speech.setVoiceBlock": "usa la voce [VOICE]",
    "text2speech.speakAndWaitBlock": "pronuncia [WORDS]",
    "text2speech.squeak": "stridula",
    "translate.categoryName": "Google Traduttore",
  ...
  "lv": {
    ...
    "microbit.displayText": "rādīt [TEXT]",
    ...
    "microbit.whenPinConnected": "kad [PIN] savienots ",
    ...
    "speech.extensionName": "Google Runa",
    ...
    "text2speech.max": "maks",
    "text2speech.monster": "briesmonis",
    "text2speech.puppy": "kucēns",
    ...
    "translate.categoryName": "Google Tulkotājs",
  ...
  "lt": {
    ...
    "microbit.tiltDirectionMenu.front": "priekį",
    ...
    "music.playDrumForBeats": "natą [DRUM]grok[BEATS] takto/us",
    "music.playNoteForBeats": "būgną [NOTE] mušk [BEATS]takto/us",
    "music.restForBeats": "ilsėkis[BEATS] smūgių",
    "music.setInstrument": "nustatyk instrumentą į [INSTRUMENT]",
    "music.setTempo": "keisk tempą į [TEMPO] ",
    ...
    "pen.changeShade": "keisk pieštuko šešėlį per [SHADE]",
    ...
    "pen.penDown": "nuleisk pieštuką",
    "pen.penUp": "pakelk pieštuką",
    "pen.setColor": "keisk pieštuko spalvą į [COLOR]",
    "pen.setColorParam": "nustatyti pieštuko [COLOR_PARAM]į [VALUE]",
    "pen.setHue": "keisk pieštuko spalvą į [HUE]",
    "pen.setShade": "nustatyti pieštuko atspalvį į [SHADE]",
    "pen.setSize": "nustatyk pieštuko dydį į [SIZE]",
    "pen.stamp": "Antspaudas",
    "speech.defaultWhenIHearValue": "eime",
    "speech.extensionName": "Google Speech",
    "speech.listenAndWait": "klausyk ir palauk",
    "speech.speechReporter": "kalba",
    "speech.whenIHear": "kai girdžiu [PHRASE]",
    "text2speech.defaultTextToSpeak": "sveiki",
    "text2speech.kitten": "kačiukas",
    "text2speech.max": "Max",
    "text2speech.monster": "monstras",
    "text2speech.puppy": "šuniukas",
    "text2speech.quinn": "Quinn",
    "text2speech.setVoiceBlock": "nustatyti balso į [VOICE]",
    "text2speech.speakAndWaitBlock": "pasikalbėk [WORDS]",
    "text2speech.squeak": "čirenti",
    "translate.categoryName": "Google Vertėjas",
    "translate.defaultTextToTranslate": "sveiki",
    ...
    "videoSensing.videoToggle": "nustatyti vaizdo modą į [VIDEO_STATE]",
    "videoSensing.whenMotionGreaterThan": "kai vaizdo judesys > [REFERENCE]",
  ...
  "mi": {
    "ev3.beepNote": "whakatangihia te oro [NOTE] mō ngā hēkona e [TIME]",
    ...
    "microbit.clearDisplay": "clear display",
    "microbit.defaultTextToDisplay": "Kia ora!",
    "microbit.displaySymbol": "display [MATRIX]",
    "microbit.displayText": "display [TEXT]",
    "microbit.gesturesMenu.jumped": "jumped",
    "microbit.gesturesMenu.moved": "moved",
  ...
  "nl": {
    ...
    "microbit.whenPinConnected": "als pin [PIN]is verbonden",
  ...
  "ja": {
    ...
    "ev3.motorTurnClockwise": "モーター[PORT]をこちら向きに[TIME]秒間回転させる",
    "ev3.motorTurnCounterClockwise": "モーター[PORT]をあちら向きに[TIME]秒間回転させる",
    ...
    "microbit.isTilted": "[DIRECTION]方向に傾いた",
    ...
    "microbit.whenPinConnected": "ピン[PIN]が地面につながったとき",
    "microbit.whenTilted": "[DIRECTION]方向に傾いたとき",
    ...
    "speech.extensionName": "Google スピーチ",
    ...
    "text2speech.monster": "モンスター",
    "text2speech.puppy": "子犬",
    ...
    "translate.categoryName": "Google翻訳",
  ...
  "ja-Hira": {
    ...
    "speech.extensionName": "グーグル・スピーチ",
    ...
    "text2speech.speakAndWaitBlock": "[WORDS]をしゃべる",
    "text2speech.squeak": "squeak",
    "translate.categoryName": "グーグルほんやく",
    "translate.defaultTextToTranslate": "こんにちは",
  ...
  "nb": {
    ...
    "microbit.tiltDirectionMenu.back": "bakerst",
    "microbit.tiltDirectionMenu.front": "foran alt",
    "microbit.tiltDirectionMenu.left": "venstre",
    ...
    "speech.extensionName": "Talegjenkjenning med Google",
  ...
  "th": {
    ...
    "ev3.whenButtonPressed": "when button [PORT] pressed",
    "ev3.whenDistanceLessThan": "when distance < [DISTANCE]",
    "microbit.buttonsMenu.any": "อะไรก็ได้",
    "microbit.clearDisplay": "clear display",
    "microbit.defaultTextToDisplay": "สวัสดี!",
    "microbit.displaySymbol": "display [MATRIX]",
    "microbit.displayText": "display [TEXT]",
    "microbit.gesturesMenu.jumped": "jumped",
    "microbit.gesturesMenu.moved": "moved",
    ...
    "microbit.tiltAngle": "tilt angle [DIRECTION]",
    "microbit.tiltDirectionMenu.any": "อะไรก็ได้",
    "microbit.tiltDirectionMenu.back": "หลังสุด",
    "microbit.tiltDirectionMenu.front": "หน้าสุด",
    ...
    "text2speech.squeak": "squeak",
    "translate.categoryName": "Google แปลภาษา",
  ...
  "pl": {
    ...
    "text2speech.max": "Max",
    "text2speech.monster": "potwór",
    "text2speech.puppy": "szczenię",
  ...
  "pt": {
    ...
    "speech.extensionName": "Processamento da Fala Google",
    ...
    "translate.categoryName": "Tradutor Google",
  ...
  "pt-br": {
    ...
    "speech.extensionName": "Sintetizador de Voz Google",
  ...
  "ru": {
    ...
    "microbit.displayText": "отобразить текст [TEXT]",
    ...
    "microbit.whenPinConnected": "когда пин-код [PIN] подключён тестово",
    ...
    "speech.extensionName": "Google Речь",
    ...
    "text2speech.kitten": "котёнок",
    "text2speech.max": "макс",
    "text2speech.monster": "монстер",
    "text2speech.puppy": "щенок",
    "text2speech.quinn": "квинн",
    "text2speech.setVoiceBlock": "установить голос [VOICE]",
    "text2speech.speakAndWaitBlock": "произносить [WORDS] ",
    "text2speech.squeak": "писк",
    "translate.categoryName": "Google Переводчик",
    ...
    "videoSensing.onFlipped": "при отражении по горизонтали",
    "videoSensing.setVideoTransparency": "установить прозрачность видео  [TRANSPARENCY]",
    "videoSensing.sprite": "спрайт",
    "videoSensing.stage": "этап",
    "videoSensing.videoOn": "видео [ATTRIBUTE] на [SUBJECT]",
    "videoSensing.videoToggle": "поворот видео [VIDEO_STATE]",
    "videoSensing.whenMotionGreaterThan": "при движении на видео > [REFERENCE]",
  ...
  "sr": {
    ...
    "speech.extensionName": "Гугл говор",
  ...
  "sk": {
    ...
    "speech.extensionName": "Google práca s rečou",
  ...
  "sl": {
    ...
    "microbit.displayText": "prikaži [TEXT]",
    ...
    "microbit.whenPinConnected": "ko je [PIN] posezan preveri",
    ...
    "text2speech.monster": "pošast",
    "text2speech.puppy": "kužek",
    "text2speech.quinn": "quinn",
  ...
  "fi": {
    ...
    "microbit.displayText": "näytä [TEXT]",
    ...
    "microbit.whenPinConnected": "kun tappi [PIN] yhdistetty",
    ...
    "speech.extensionName": "Google Puhe",
  ...
  "sv": {
    ...
    "microbit.displayText": "visa [TEXT]",
    ...
    "microbit.whenPinConnected": "om pin [PIN] kopplas upp",
  ...
  "vi": {
    ...
    "pen.stamp": "in hình",
    "speech.defaultWhenIHearValue": "let''s go",
    "speech.extensionName": "Google Giọng nói",
    "speech.listenAndWait": "listen and wait",
    "speech.speechReporter": "speech",
    "speech.whenIHear": "when I hear [PHRASE]",
    ...
    "text2speech.squeak": "squeak",
    "translate.categoryName": "Google Dịch",
  ...
  "tr": {
    ...
    "microbit.isButtonPressed": "[BTN] button pressed?",
    "microbit.isTilted": "tilted [DIRECTION]?",
    "microbit.pinStateMenu.off": "kapat",
    "microbit.pinStateMenu.on": "aç",
    "microbit.tiltAngle": "tilt angle [DIRECTION]",
    ...
    "speech.extensionName": "Google Konuşma",
  ...
  "uk": {
    ...
    "microbit.displayText": "показати [TEXT]",
    ...
    "speech.extensionName": "Мовлення від Google",
  ...
  "zh-cn": {
    ...
    "wedo2.getTiltAngle": "[TILT_DIRECTION]倾角",
    "wedo2.isTilted": "[TILT_DIRECTION_ANY]倾？",
    ...
    "wedo2.whenTilted": "当倾向[TILT_DIRECTION_ANY]"
  },
  "zh-tw": {
    ...
    "ev3.motorSetPower": "馬達 [PORT] 動力設為 [POWER] %",
    "ev3.motorTurnClockwise": "馬達 [PORT] 順時針旋轉 [TIME] 秒",
    "ev3.motorTurnCounterClockwise": "馬達 [PORT] 逆時針旋轉 [TIME] 秒",
    ...
    "microbit.tiltDirectionMenu.back": "最下",
    "microbit.tiltDirectionMenu.front": "最上",
    "microbit.tiltDirectionMenu.left": "左",
    "microbit.tiltDirectionMenu.right": "右",
    ...
    "speech.extensionName": "Google 語音",
    ...
    "text2speech.max": "麥克斯",
    "text2speech.monster": "怪獸",
    "text2speech.puppy": "小狗",
    "text2speech.quinn": "奎因",
    "text2speech.setVoiceBlock": "語音設為 [VOICE]",
    "text2speech.speakAndWaitBlock": "唸出 [WORDS]",
    "text2speech.squeak": "尖細",
    "translate.categoryName": "Google 翻譯",
    "translate.defaultTextToTranslate": "hello",
    "translate.translateBlock": "翻譯 [WORDS] 成 [LANGUAGE]",
    "translate.viewerLanguage": "語言",
