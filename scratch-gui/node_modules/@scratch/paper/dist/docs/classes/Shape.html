...
&mdash;&nbsp;optional, default: <tt>true</tt>
	...
	<ul class="member-list">
		<h4>Returns:</h4>
			...
			<li>
<tt><a href="../classes/Shape.html"><tt>Shape</tt></a></tt>&nbsp;&mdash;&nbsp;the newly created path item with the same geometry as  this shape item
</li>
...
<div class="canvas"><canvas width="516" height="120" id="canvas-29"></canvas></div>
</div>
...
<div class="canvas"><canvas width="516" height="240" id="canvas-36"></canvas></div>
</div>
